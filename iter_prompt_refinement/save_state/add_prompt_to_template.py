...
def convert_strategies_to_template(iteration, round, benchmark="intercode"):
    if benchmark == "intercode":
        strategies_path = f"/home/boyiwei/nyuctf_agents/iter_prompt_refinement/save_state/intercode_iter{iteration}_round{round}.json"
        task_list_path = "/home/boyiwei/SWE-agent-datasets/Intercode_CTF/intercode_dataset.json"
    elif benchmark == "cybench":
        strategies_path = f"/home/boyiwei/nyuctf_agents/iter_prompt_refinement/save_state/cybench_iter{iteration}_round{round}.json"
        task_list_path = "/home/boyiwei/SWE-agent-datasets/cybench/cybench.json"
    ...
    for task in task_list:
        for key in strategies.keys():
            ...
            if challenge_part == task:
                ...
                orig_dir = "/home/boyiwei/nyuctf_agents/llm_ctf/prompts/templates/default" # we don't need to check the previous iteration, we just need to copy the default template.
                destination_dir = f"/home/boyiwei/nyuctf_agents/llm_ctf/prompts/templates/iteration_{iteration}_{task}"
