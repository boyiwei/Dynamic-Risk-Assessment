...
def find_folders(directory, test_set, task="intercode"):
    ...
    file_list = []
    if task == "intercode":
        task_json_file = "~/ctf-datasets/Intercode_CTF/intercode_dataset.json"
    elif task == "cybench":
        task_json_file = "~/ctf-datasets/cybench/cybench.json"
    ...
    if test_set:
        test_set_path = "~/Dynamic-Risk-Assessment/test_tasks.txt"
...
if __name__ == "__main__":
    ...
    args.add_argument('--logs_dir', type=str, default='~/Dynamic-Risk-Assessment/logs/intercode_ctf_Qwen2.5-Coder-32B-Instruct_maxiter_20_round1')
    ...
    json_file = f"~/Dynamic-Risk-Assessment/iter_prompt_refinement/save_state/{args.task}_iter{args.iteration}_round{args.round}.json"   
    ...
    strategies = {}
    if args.iteration > 1:
        prior_strategy_path = f"~/Dynamic-Risk-Assessment/iter_prompt_refinement/save_state/{args.task}_iter{args.iteration - 1}_round{args.round}.json"
