...
if __name__ == "__main__":
    ...
    args.add_argument('--logs_dir', type=str, default='logs/intercode_ctf_Qwen2.5-Coder-32B-Instruct_maxiter_20_round1')
    ...
    strategies = {}
    if args.iteration > 1:
        prior_strategy_path = f"iter_prompt_refinement/save_state/{args.task}_iter{args.iteration - 1}_round{args.round}.json"
