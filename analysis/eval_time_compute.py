...
def compute_time(args):
    ...
    for round in range(1, 11):
        ...
        file_dir = f"logs/intercode_ctf_Qwen2.5-Coder-32B-Instruct_maxiter_20_round{round}/"
        # find all json files in the directory
        json_files = [f for f in os.listdir(file_dir) if f.endswith('.json')]
        
        task_mask = "analysis/train_tasks.txt"
        unsolvable_task_mask = "analysis/unsolvable_tasks.txt"
