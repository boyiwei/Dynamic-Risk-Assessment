...
if __name__ == '__main__':
    ...
    args.add_argument('--file_dir', type=str, default='/home/boyiwei/nyuctf_agents/analysis/successful_tasks_lists/successful_tasks_intercode_ctf_Qwen2.5-Coder-32B-Instruct_maxiter_20_train_round4.txt')
